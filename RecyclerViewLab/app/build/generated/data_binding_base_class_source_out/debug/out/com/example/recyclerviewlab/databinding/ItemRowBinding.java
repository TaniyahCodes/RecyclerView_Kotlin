...
package com.example.recyclerviewlab.databinding;
...
public final class ItemRowBinding implements ViewBinding {
  ...
  private ItemRowBinding(@NonNull MaterialCardView rootView, @NonNull TextView itemSubtitle,
  ...
  public static ItemRowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRowBinding((MaterialCardView) rootView, itemSubtitle, itemTitle);
    }
